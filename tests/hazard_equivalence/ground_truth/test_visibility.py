import numpy as np
from sledge.hazard_equivalence.core.types import ActorState, ActorType
from sledge.hazard_equivalence.ground_truth import OcclusionType, compute_visibility
